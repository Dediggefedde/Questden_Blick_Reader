...
//class ThreadRequest(
//    url: String, private val mode: ThrdItemTyps, private val newestId: String?,
//    private val headers: MutableMap<String, String>?,
//    private val listener: Response.Listener<MutableList<TgPost>>,
//    errorListener: Response.ErrorListener
//) : Request<MutableList<TgPost>>(Method.GET, url, errorListener) {
//
//    override fun getHeaders(): MutableMap<String, String> = headers ?: super.getHeaders()
//
//    override fun deliverResponse(response: MutableList<TgPost>?) = listener.onResponse(response)
//
//    override fun parseNetworkResponse(response: NetworkResponse?): Response<MutableList<TgPost>> {
//        return try {
//            var li: MutableList<TgPost>
//            if (response == null) {
...
//
//                if (mode==ThrdItemTyps.THREAD) { //single requests
...
//                    if(retn.count()>0)
//                       li.add(TgPost("thread_info","","","",retn.last().groupValues.last()))
//                }
//                Response.success(
//                    li,
